...
var (
	...
	ModelAPIKeysColumns = []*schema.Column{
		...
		{Name: "api_key", Type: field.TypeString, Size: 2147483647},
		{Name: "device_secret", Type: field.TypeString, Nullable: true},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ModelAPIKeysColumns[9]},
	...
	PlansColumns = []*schema.Column{
		...
		{Name: "daily_token_quota", Type: field.TypeInt64, Default: 0},
		{Name: "weekly_token_quota", Type: field.TypeInt64, Default: 0},
		{Name: "monthly_token_quota", Type: field.TypeInt64, Default: 0},
	...
	WalletsColumns = []*schema.Column{
		...
		{Name: "daily_token_balance", Type: field.TypeInt64, Default: 0},
		{Name: "weekly_token_balance", Type: field.TypeInt64, Default: 0},
		{Name: "monthly_token_balance", Type: field.TypeInt64, Default: 0},
		{Name: "daily_reset_at", Type: field.TypeTime, Nullable: true},
		{Name: "weekly_reset_at", Type: field.TypeTime, Nullable: true},
