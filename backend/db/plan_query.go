...
func (_q *PlanQuery) QuerySubscriptions() *UserSubscriptionQuery {
...
func (_q *PlanQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PlanQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *PlanQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *PlanQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *PlanQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *PlanQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PlanQuery) WithSubscriptions(opts ...func(*UserSubscriptionQuery)) *PlanQuery {
	query := (&UserSubscriptionClient{config: _q.config}).Query()
...
func (_q *PlanQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Plan, error) {
	...
	if query := _q.withSubscriptions; query != nil {
		if err := _q.loadSubscriptions(ctx, query, nodes,
			func(n *Plan) { n.Edges.Subscriptions = []*UserSubscription{} },
			func(n *Plan, e *UserSubscription) { n.Edges.Subscriptions = append(n.Edges.Subscriptions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PlanQuery) loadSubscriptions(ctx context.Context, query *UserSubscriptionQuery, nodes []*Plan, init func(*Plan), assign func(*Plan, *UserSubscription)) error {
