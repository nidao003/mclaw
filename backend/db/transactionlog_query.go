...
//		GroupBy(transactionlog.FieldUserID).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
...
//
//	client.TransactionLog.Query().
//		Select(transactionlog.FieldUserID).
//		Scan(ctx, &v)
...
func (_q *TransactionLogQuery) Modify(modifiers ...func(s *sql.Selector)) *TransactionLogSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *TransactionLogSelect) Modify(modifiers ...func(s *sql.Selector)) *TransactionLogSelect {
