...
func (_q *UserSubscriptionQuery) QueryPlan() *PlanQuery {
...
func (_q *UserSubscriptionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UserSubscriptionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *UserSubscriptionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *UserSubscriptionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *UserSubscriptionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *UserSubscriptionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserSubscriptionQuery) WithPlan(opts ...func(*PlanQuery)) *UserSubscriptionQuery {
	query := (&PlanClient{config: _q.config}).Query()
...
//		GroupBy(usersubscription.FieldDeletedAt).
//		Aggregate(db.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserSubscription.Query().
//		Select(usersubscription.FieldDeletedAt).
//		Scan(ctx, &v)
...
func (_q *UserSubscriptionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserSubscription, error) {
	...
	if query := _q.withPlan; query != nil {
		if err := _q.loadPlan(ctx, query, nodes, nil,
			func(n *UserSubscription, e *Plan) { n.Edges.Plan = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserSubscriptionQuery) loadPlan(ctx context.Context, query *PlanQuery, nodes []*UserSubscription, init func(*UserSubscription), assign func(*UserSubscription, *Plan)) error {
...
func (_q *UserSubscriptionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usersubscription.Table, usersubscription.Columns, sqlgraph.NewFieldSpec(usersubscription.FieldID, field.TypeUUID))
	_spec.From = _q.sql
