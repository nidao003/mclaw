...
const OPENCLAW_IMAGE_GENERATION_RUNTIME = 'mclaw/plugin-sdk/image-generation-runtime';
const OPENCLAW_MEDIA_STORE = 'mclaw/plugin-sdk/media-store';
const OPENCLAW_MEDIA_RUNTIME = 'mclaw/plugin-sdk/media-runtime';
const OPENCLAW_IMAGE_GENERATION_CORE = 'mclaw/plugin-sdk/image-generation-core';
