#!/usr/bin/env node
/**
 * Generates extension bridge files based on mclaw-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'mclaw-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure mclaw-extensions.json and link the package.',
