...
function SelectField({ className, children, ...props }: SelectFieldProps) {
  return (
    <div className="relative">
      <Select
        className={cn(
          'h-[44px] rounded-xl border-border bg-background text-meta pr-10 [background-image:none] appearance-none',
          className,
        )}
        {...props}
      >
    ...
    <Dialog open={open} onOpenChange={(nextOpen) => !nextOpen && onClose()}>
      <DialogContent asChild className="w-[calc(100%-2rem)] max-w-lg max-h-[90vh] flex flex-col rounded-3xl border-0 shadow-2xl bg-surface-modal overflow-hidden">
        ...
        <CardHeader className="flex flex-row items-start justify-between pb-2 shrink-0">
          ...
          <Button variant="ghost" size="icon" onClick={onClose} className="rounded-full h-8 w-8 -mr-2 -mt-2 text-muted-foreground hover:text-foreground hover:bg-accent/50">
            <X className="h-4 w-4" />
          </Button>
        </CardHeader>
        <CardContent className="space-y-6 pt-4 overflow-y-auto flex-1 p-6">
          ...
          <div className="space-y-2.5">
            ...
            <Input
              ...
              className="h-[44px] rounded-xl font-mono text-meta bg-transparent border-border focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40"
            />
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <Textarea
              ...
              rows={3}
              className="rounded-xl font-mono text-meta bg-transparent border-border focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40 resize-none"
            />
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <SelectField
              ...
              className="h-[44px] rounded-xl border-border bg-transparent text-meta"
            >
              {agents.map((agent) => (
          ...
          <div className="space-y-2.5">
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      schedule === preset.value
                        ...
                        : "bg-transparent border-border hover:bg-accent/50 text-foreground/80 hover:text-foreground"
                    )}
                  >
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <Button
                ...
                className="text-xs h-7 px-2 text-foreground/60 hover:text-foreground hover:bg-accent/50 rounded-lg"
              >
          ...
          <div className="space-y-3">
            ...
            {deliveryMode === 'announce' && (
              <div className="space-y-3 rounded-2xl border border-border/50 bg-transparent p-4 shadow-sm">
          ...
          {/* Enabled */}
          <div className="flex items-center justify-between bg-transparent p-4 rounded-2xl shadow-sm border border-border/50">
            <div>
          ...
          <div className="flex justify-end gap-3 pt-4">
            <Button variant="outline" onClick={onClose} className="rounded-full px-6 h-[42px] text-meta font-semibold border-black/20 dark:border-white/20 bg-transparent hover:bg-accent/50 text-foreground/80 hover:text-foreground shadow-sm">
...
function CronJobCard({ job, deliveryAccountName, onToggle, onEdit, onDelete, onTrigger }: CronJobCardProps) {
  ...
  return (
    <div
      ...
      className="group flex flex-col p-5 rounded-2xl bg-transparent border border-transparent hover:bg-accent/50 transition-all relative overflow-hidden cursor-pointer"
      onClick={onEdit}
    >
      <div className="flex items-start justify-between gap-3 mb-4">
        <div className="flex items-center gap-4 min-w-0 flex-1">
          <div className="h-[46px] w-[46px] shrink-0 flex items-center justify-center text-foreground bg-accent/50 border border-border/50 rounded-full shadow-sm group-hover:scale-105 transition-transform">
      ...
      <div className="flex-1 flex flex-col justify-end mt-2 pl-[62px] min-w-0">
        ...
        <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity mt-auto">
          <Button
            ...
            disabled={triggering}
            className="h-8 px-3 text-foreground/70 hover:text-foreground hover:bg-accent/50 rounded-lg text-meta font-medium transition-colors"
          >
            {triggering ? (
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col h-full p-10 pt-16">
        ...
        <div className="flex-1 overflow-y-auto pr-2 pb-10 min-h-0 -mr-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="p-5 rounded-[24px] bg-accent/50 border border-transparent flex flex-col justify-between min-h-[130px] relative overflow-hidden group hover:bg-black/10 dark:hover:bg-white/10 transition-colors">
          ...
          {/* Jobs List */}
          {safeJobs.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-muted-foreground bg-accent/50 rounded-3xl border border-transparent border-dashed">
