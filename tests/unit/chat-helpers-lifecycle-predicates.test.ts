 ...
 * mclaw's UI keeps the Thinking… indicator / Execution Graph "active" or
 * tears them down.
 *
 * In production, mclaw consumes already-normalized messages from the OpenClaw
 ...
 * provider protocols mclaw may encounter.
 */
